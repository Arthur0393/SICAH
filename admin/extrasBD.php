...
if($_POST['opcion']==1)
{
	...
	$idregresado = $Seani->obtieneIdProyecto($id_carrera,$id_docente,$id_concepto,27);	//se agregó parametro
	...
	$cacha = $Seani->VerificaExisteConcepto($id_docente, $id_carrera, $id_concepto, 27);	//se agregó parámetro
