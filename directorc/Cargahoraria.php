          ...
          <div class="tab_container" >
            ...
            <div id="tab1" class="tab_content"> 
                ...
                <div id="divCuenta" style="display:none">
                    ...
                    $Seani->TablePTCAdminPorDirector($idusuario, 24);
                    ...
                    /*    $sqlx = "SELECT carrera from director_carrera where user_ide=$idusuario;";
                        ...
                        while($filax=mysql_fetch_row($resultx)){ 
                            ...
                            $Seani->ptcVSpaporCarrera($filax[0],$abrevia[0],24);
                        }
                        echo "</table>";*/
                    ?>
                <!--<hr>
                  <?php //echo $ConsultaHoras = $Seani->ptcVSpa(24); //se agreg parametro?>
                <hr>-->
              </div>
            ...
            <button id="ExportaEX">EXCEL</button>
              ...
              <table id="tableConten" class="table table-bordered table-striped  data_table3"  >
                ...
                <tbody align="center">
                  ...
                  <?php   echo   $DatosPersonaleTabla = $Seani->ReporteporDirector($idusuario,24); //se agregó parametro    ?>     
